...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__27925_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__27925_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__27925_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__27926){
var vec__27927 = p__27926;
var low = cljs.core.nth.call(null,vec__27927,(0),null);
var high = cljs.core.nth.call(null,vec__27927,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__27930,s,color,element,idx){
var map__27931 = p__27930;
var map__27931__$1 = ((((!((map__27931 == null)))?(((((map__27931.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27931.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27931):map__27931);
var style_map = cljs.core.get.call(null,map__27931__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__27931__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__27931__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__27933){
var vec__27934 = p__27933;
var s = cljs.core.nth.call(null,vec__27934,(0),null);
var style = cljs.core.nth.call(null,vec__27934,(1),null);
var start = cljs.core.nth.call(null,vec__27934,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__27937){
var vec__27938 = p__27937;
var s = cljs.core.nth.call(null,vec__27938,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__27938,(1),null);
var element = cljs.core.nth.call(null,vec__27938,(2),null);
...
var G__27941 = cljs.core.next.call(null,ssv);
var G__27942 = (this_ssv == null);
var G__27943 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__27944 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && (!((this_ssv == null)))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__27941;
doing_nil_QMARK_ = G__27942;
last_elide = G__27943;
out = G__27944;
continue;
}
...
var vec__27945 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__27945,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__27945,(1),null);
var element_type = cljs.core.nth.call(null,vec__27945,(2),null);
...
var G__27948 = cljs.core.next.call(null,remaining_cvec);
var G__27949 = new_idx;
var G__27950 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__27948;
idx = G__27949;
out = G__27950;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__27961,cursor_vec){
var vec__27962 = p__27961;
var focus_start = cljs.core.nth.call(null,vec__27962,(0),null);
var focus_end = cljs.core.nth.call(null,vec__27962,(1),null);
var focus_vec = vec__27962;
...
var vec__27965 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__27965,(0),null);
var back = cljs.core.nth.call(null,vec__27965,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__27968){
var vec__27969 = p__27968;
var s = cljs.core.nth.call(null,vec__27969,(0),null);
var color = cljs.core.nth.call(null,vec__27969,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__27975,existing_count){
var vec__27976 = p__27975;
var s = cljs.core.nth.call(null,vec__27976,(0),null);
var cursor = cljs.core.nth.call(null,vec__27976,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__27976,s,cursor){
return (function (p1__27972_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__27972_SHARP_)));
});})(s__$1,len,cursor__$1,vec__27976,s,cursor))
...
var vec__27980 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__27980,(0),null);
var where = cljs.core.nth.call(null,vec__27980,(1),null);
var cvec_element = vec__27980;
if((cvec_element == null)){
var G__27983 = cljs.core.next.call(null,cvec_nl);
var G__27984 = (idx + (1));
var G__27985 = start;
var G__27986 = out;
cvec_nl = G__27983;
...
var G__27987 = cljs.core.next.call(null,cvec_nl);
var G__27988 = (idx + (1));
var G__27989 = idx;
var G__27990 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__27987;
idx = G__27988;
start = G__27989;
out = G__27990;
...
var G__27991 = cljs.core.next.call(null,cvec_nl);
var G__27992 = (idx + (1));
var G__27993 = (idx + (1));
var G__27994 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__27991;
idx = G__27992;
start = G__27993;
out = G__27994;
...
var G__27995 = cljs.core.next.call(null,cvec_nl);
var G__27996 = (idx + (1));
var G__27997 = idx;
var G__27998 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__27995;
idx = G__27996;
start = G__27997;
out = G__27998;
...
var G__27999 = cljs.core.next.call(null,cvec_nl);
var G__28000 = (idx + (1));
var G__28001 = start;
var G__28002 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__27999;
idx = G__28000;
start = G__28001;
out = G__28002;
...
return cljs.core.reduce.call(null,(function (p1__28004_SHARP_,p2__28003_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_.call(null,idx,p2__28003_SHARP_))){
return cljs.core.reduced.call(null,p1__28004_SHARP_);
} else {
return (p1__28004_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28005,p__28006){
var vec__28007 = p__28005;
var focus_begin = cljs.core.nth.call(null,vec__28007,(0),null);
var focus_end = cljs.core.nth.call(null,vec__28007,(1),null);
var vec__28010 = p__28006;
var before = cljs.core.nth.call(null,vec__28010,(0),null);
var after = cljs.core.nth.call(null,vec__28010,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28014,cvec,focus_vec){
...
var options = map__28015__$1;
var map__28016 = cljs.core.get.call(null,map__28015__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__28016__$1 = ((((!((map__28016 == null)))?(((((map__28016.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28016.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28016):map__28016);
var focus = cljs.core.get.call(null,map__28016__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__28016__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__28016__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__28015,map__28015__$1,options,map__28016,map__28016__$1,focus,lines,paths){
return (function (p1__28013_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__28013_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__28015,map__28015__$1,options,map__28016,map__28016__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1543701286510

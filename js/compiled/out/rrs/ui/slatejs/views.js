 ...
 */
rrs.ui.slatejs.views.editor = (function rrs$ui$slatejs$views$editor(section_data){
var section_key = new cljs.core.Keyword(null,"section-key","section-key",-932493555).cljs$core$IFn$_invoke$arity$1(section_data);
...
var on_change_fn = ((function (section_key,this_atom,cached_editor_values_atom,editor_ref_atom){
...
});})(section_key,this_atom,cached_editor_values_atom,editor_ref_atom))
;
var update_editor_ref_fn = ((function (section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn){
...
});})(section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn))
;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"slatejs-editor-inner",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn,update_editor_ref_fn){
return (function (this$){
return cljs.core.reset_BANG_.call(null,this_atom,this$);
});})(section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn,update_editor_ref_fn))
,new cljs.core.Keyword(null,"component-will-unmount","component-will-unmount",-2058314698),((function (section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn,update_editor_ref_fn){
return (function (){
return cljs.core.reset_BANG_.call(null,this_atom,null);
});})(section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn,update_editor_ref_fn))
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (section_key,this_atom,cached_editor_values_atom,editor_ref_atom,on_change_fn,update_editor_ref_fn){
return (function (_){
...
//# sourceMappingURL=views.js.map?rel=1543701277571

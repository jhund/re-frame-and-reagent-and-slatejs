...
var G__26332 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26332;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26333 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26333,ch);
...
if(("\\" === ch__$1)){
var ch_26334__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26334__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26334__$2);
} else {
}

var G__26335 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26335;
continue;
}
}
...
var vec__26343 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26343,(0),null);
var start_column = cljs.core.nth.call(null,vec__26343,(1),null);
...
var G__26346 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26346;
continue;
}
}
...
var _STAR_read_delim_STAR_26347 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26347;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26348 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26348,(0),null);
var start_column = cljs.core.nth.call(null,vec__26348,(1),null);
...
var vec__26351 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26351,(0),null);
var end_column = cljs.core.nth.call(null,vec__26351,(1),null);
...
var vec__26354 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26354,(0),null);
var start_column = cljs.core.nth.call(null,vec__26354,(1),null);
...
var vec__26357 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26357,(0),null);
var end_column = cljs.core.nth.call(null,vec__26357,(1),null);
...
var vec__26360 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26360,(0),null);
var start_column = cljs.core.nth.call(null,vec__26360,(1),null);
...
var vec__26363 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26363,(0),null);
var end_column = cljs.core.nth.call(null,vec__26363,(1),null);
...
var sb = (function (){var G__26366 = (new goog.string.StringBuffer());
G__26366.append(initch);
...
var G__26368 = (function (){var G__26367 = sb;
G__26367.append(ch);

return G__26367;
})();
var G__26369 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26368;
ch = G__26369;
continue;
}
...
switch (G__26372) {
case "\\":
var G__26376 = (function (){var G__26373 = sb;
G__26373.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26373;
})();
var G__26377 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26376;
ch = G__26377;
continue;
...
break;
default:
var G__26378 = (function (){var G__26374 = sb;
G__26374.append(ch);

return G__26374;
})();
var G__26379 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26378;
ch = G__26379;
continue;
...
var vec__26380 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26380,(0),null);
var end_column = cljs.core.nth.call(null,vec__26380,(1),null);
...
var vec__26383 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26383,(0),null);
var column = cljs.core.nth.call(null,vec__26383,(1),null);
...
var vec__26388 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26388,(0),null);
var column = cljs.core.nth.call(null,vec__26388,(1),null);
...
var vec__26393 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26393,(0),null);
var column = cljs.core.nth.call(null,vec__26393,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26398 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26398,(0),null);
var start_column = cljs.core.nth.call(null,vec__26398,(1),null);
...
var vec__26401 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26401,(0),null);
var end_column = cljs.core.nth.call(null,vec__26401,(1),null);
...
var G__26404 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26404,true,null,opts,pending_forms);
...
var G__26405 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26405)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26405)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26405)){
...
var _STAR_suppress_read_STAR_26406 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26406;
}});
...
var G__26407 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26407,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26407,rdr,first_line);
...
var G__26411 = matched;
var G__26412 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26411;
finished = G__26412;
continue;
} else {
...
var _STAR_suppress_read_STAR_26413 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26413;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26414 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26415 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26415,"(");
...
var G__26416 = (i + (1));
var G__26417 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26414;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26418 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26418);
...
var G__26419 = cljs.core.next.call(null,s__$1);
var G__26420 = ret;
s__$1 = G__26419;
r = G__26420;
continue;
...
var G__26421 = cljs.core.next.call(null,s);
var G__26422 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26421;
key_vals = G__26422;
continue;
} else {
...
var gensym_env26426 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26426;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26427 = token;
var G__26427__$1 = (((G__26427 == null))?null:cljs.core.subs.call(null,G__26427,(1)));
var G__26427__$2 = (((G__26427__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26427__$1));
var G__26427__$3 = (((G__26427__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26427__$2));
var G__26427__$4 = (((G__26427__$3 == null))?null:cljs.core.symbol.call(null,G__26427__$3));
if((G__26427__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26427__$4);
}
})():(function (){var G__26428 = token;
var G__26428__$1 = (((G__26428 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26428));
if((G__26428__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26428__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e26435){if((e26435 instanceof Error)){
var e = e26435;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26439,reader){
...
var eof = cljs.core.get.call(null,map__26440__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___26448 = arguments.length;
var i__4532__auto___26449 = (0);
while(true){
if((i__4532__auto___26449 < len__4531__auto___26448)){
args__4534__auto__.push((arguments[i__4532__auto___26449]));

var G__26450 = (i__4532__auto___26449 + (1));
i__4532__auto___26449 = G__26450;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26446){
var G__26447 = cljs.core.first.call(null,seq26446);
var seq26446__$1 = cljs.core.next.call(null,seq26446);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26447,seq26446__$1);
});


//# sourceMappingURL=reader.js.map?rel=1543803801678

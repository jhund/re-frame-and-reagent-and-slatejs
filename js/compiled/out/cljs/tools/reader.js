...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26061 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26061,ch);
...
if(("\\" === ch__$1)){
var ch_26062__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26062__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26062__$2);
} else {
}

var G__26063 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26063;
continue;
}
}
...
var vec__26071 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26071,(0),null);
var start_column = cljs.core.nth.call(null,vec__26071,(1),null);
...
var G__26074 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26074;
continue;
}
}
...
var _STAR_read_delim_STAR_26075 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26075;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26076 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26076,(0),null);
var start_column = cljs.core.nth.call(null,vec__26076,(1),null);
...
var vec__26079 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26079,(0),null);
var end_column = cljs.core.nth.call(null,vec__26079,(1),null);
...
var vec__26082 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26082,(0),null);
var start_column = cljs.core.nth.call(null,vec__26082,(1),null);
...
var vec__26085 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26085,(0),null);
var end_column = cljs.core.nth.call(null,vec__26085,(1),null);
...
var vec__26088 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26088,(0),null);
var start_column = cljs.core.nth.call(null,vec__26088,(1),null);
...
var vec__26091 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26091,(0),null);
var end_column = cljs.core.nth.call(null,vec__26091,(1),null);
...
var sb = (function (){var G__26094 = (new goog.string.StringBuffer());
G__26094.append(initch);
...
var G__26096 = (function (){var G__26095 = sb;
G__26095.append(ch);

return G__26095;
})();
var G__26097 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26096;
ch = G__26097;
continue;
}
...
switch (G__26100) {
case "\\":
var G__26104 = (function (){var G__26101 = sb;
G__26101.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26101;
})();
var G__26105 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26104;
ch = G__26105;
continue;
...
break;
default:
var G__26106 = (function (){var G__26102 = sb;
G__26102.append(ch);

return G__26102;
})();
var G__26107 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26106;
ch = G__26107;
continue;
...
var vec__26108 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26108,(0),null);
var end_column = cljs.core.nth.call(null,vec__26108,(1),null);
...
var vec__26111 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26111,(0),null);
var column = cljs.core.nth.call(null,vec__26111,(1),null);
...
var vec__26116 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26116,(0),null);
var column = cljs.core.nth.call(null,vec__26116,(1),null);
...
var vec__26121 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26121,(0),null);
var column = cljs.core.nth.call(null,vec__26121,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26126 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26126,(0),null);
var start_column = cljs.core.nth.call(null,vec__26126,(1),null);
...
var vec__26129 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26129,(0),null);
var end_column = cljs.core.nth.call(null,vec__26129,(1),null);
...
var G__26132 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26132,true,null,opts,pending_forms);
...
var G__26133 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26133)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26133)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26133)){
...
var _STAR_suppress_read_STAR_26134 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26134;
}});
...
var G__26135 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26135,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26135,rdr,first_line);
...
var G__26139 = matched;
var G__26140 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26139;
finished = G__26140;
continue;
} else {
...
var _STAR_suppress_read_STAR_26141 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26141;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26142 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26143 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26143,"(");
...
var G__26144 = (i + (1));
var G__26145 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26142;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26146 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26146);
...
var G__26147 = cljs.core.next.call(null,s__$1);
var G__26148 = ret;
s__$1 = G__26147;
r = G__26148;
continue;
...
var G__26149 = cljs.core.next.call(null,s);
var G__26150 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26149;
key_vals = G__26150;
continue;
} else {
...
var gensym_env26154 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26154;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26155 = token;
var G__26155__$1 = (((G__26155 == null))?null:cljs.core.subs.call(null,G__26155,(1)));
var G__26155__$2 = (((G__26155__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26155__$1));
var G__26155__$3 = (((G__26155__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26155__$2));
var G__26155__$4 = (((G__26155__$3 == null))?null:cljs.core.symbol.call(null,G__26155__$3));
if((G__26155__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26155__$4);
}
})():(function (){var G__26156 = token;
var G__26156__$1 = (((G__26156 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26156));
if((G__26156__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26156__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e26163){if((e26163 instanceof Error)){
var e = e26163;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26167,reader){
...
var eof = cljs.core.get.call(null,map__26168__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___26176 = arguments.length;
var i__4532__auto___26177 = (0);
while(true){
if((i__4532__auto___26177 < len__4531__auto___26176)){
args__4534__auto__.push((arguments[i__4532__auto___26177]));

var G__26178 = (i__4532__auto___26177 + (1));
i__4532__auto___26177 = G__26178;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26174){
var G__26175 = cljs.core.first.call(null,seq26174);
var seq26174__$1 = cljs.core.next.call(null,seq26174);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26175,seq26174__$1);
});


//# sourceMappingURL=reader.js.map?rel=1543701281899

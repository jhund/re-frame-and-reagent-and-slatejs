...
if((c === "\n")){
var G__26533 = escape_QMARK_;
var G__26534 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__26533;
lines = G__26534;
continue;
} else {
buf.append(c);

var G__26535 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__26536 = lines;
escape_QMARK_ = G__26535;
lines = G__26536;
continue;
...
//# sourceMappingURL=string.js.map?rel=1543701283150

...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__22560 = cljs.core.instance_QMARK_;
var expr__22561 = reactive_val;
if(cljs.core.truth_(pred__22560.call(null,reagent.ratom.RAtom,expr__22561))){
return "ra";
} else {
if(cljs.core.truth_(pred__22560.call(null,reagent.ratom.RCursor,expr__22561))){
return "rc";
} else {
if(cljs.core.truth_(pred__22560.call(null,reagent.ratom.Reaction,expr__22561))){
return "rx";
} else {
if(cljs.core.truth_(pred__22560.call(null,reagent.ratom.Track,expr__22561))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1543803795654

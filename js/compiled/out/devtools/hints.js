...
}catch (e32592){var _e = e32592;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___32595 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___32595)){
var seen_errors_32596 = temp__5455__auto___32595;
if(cljs.core.truth_(seen_errors_32596.has(self))){
} else {
seen_errors_32596.add(self);

var temp__5457__auto___32597 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___32597)){
var sense_32598 = temp__5457__auto___32597;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32598)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1543701294753

...
var o24346 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24346["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24347 = temp__5455__auto____$1;
return (o24347["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23456__auto__ = f;
return (o__23456__auto__["toString"]).call(o__23456__auto__);
} else {
return "";
}
}catch (e24348){var _ = e24348;
return "";
}});
...
try{var o__23456__auto___24350 = t;
(o__23456__auto___24350["cljs$lang$ctorPrWriter"]).call(o__23456__auto___24350,t,writer);
}catch (e24349){var __24351 = e24349;
}
...
var char_code = (function (){var o__23456__auto__ = (new String(char$));
return (o__23456__auto__["charCodeAt"]).call(o__23456__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23456__auto__ = String;
return (o__23456__auto__["fromCharCode"]).call(o__23456__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24352 = num_code;
switch (G__24352) {
case (1):
return (185);
...
var o__23456__auto__ = String;
return (o__23456__auto__["fromCharCode"]).call(o__23456__auto__,superscript_code);
});
/**
...
}catch (e24354){var _e__23463__auto__ = e24354;
return false;
}})())){
...
var vec__24355 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24355,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24358 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24358["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24359 = temp__5455__auto____$1;
return (o24359["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24362){
var vec__24363 = p__24362;
var ns_detector = cljs.core.nth.call(null,vec__24363,(0),null);
...
var G__24369 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24370 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24369;
remaining_tokens = G__24370;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24360){
var G__24361 = cljs.core.first.call(null,seq24360);
var seq24360__$1 = cljs.core.next.call(null,seq24360);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24361,seq24360__$1);
});
...
var vec__24374 = cljs.core.split_with.call(null,(function (p1__24373_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24373_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24374,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24374,(1),null);
...
var vec__24377 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24377,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24377,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24380 = cljs.core.rest.call(null,remaining_tokens);
var G__24381 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24380;
name_tokens = G__24381;
continue;
} else {
...
var vec__24384 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24384,(0),null);
var arity = cljs.core.nth.call(null,vec__24384,(1),null);
var vec__24387 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24387,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24387,(1),null);
var vec__24390 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24390,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24390,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24390,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24390,(3),null);
...
var vec__24396 = result;
var munged_ns = cljs.core.nth.call(null,vec__24396,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24396,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24396,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24396,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24396,(4),null);
var arity = cljs.core.nth.call(null,vec__24396,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__24400 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__24400,(0),null);
var args = cljs.core.nth.call(null,vec__24400,(1),null);
var vec__24403 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24403,(0),null);
var name = cljs.core.nth.call(null,vec__24403,(1),null);
...
var G__24406 = (arity + (1));
var G__24407 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24408){
var vec__24409 = p__24408;
var arity = cljs.core.nth.call(null,vec__24409,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24409,(1),null);
...
return cljs.core.get.call(null,arities,p1__24412_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24413_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___24420 = arguments.length;
var i__4532__auto___24421 = (0);
while(true){
if((i__4532__auto___24421 < len__4531__auto___24420)){
args__4534__auto__.push((arguments[i__4532__auto___24421]));

var G__24422 = (i__4532__auto___24421 + (1));
i__4532__auto___24421 = G__24422;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24416){
var vec__24417 = p__24416;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24417,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24414){
var G__24415 = cljs.core.first.call(null,seq24414);
var seq24414__$1 = cljs.core.next.call(null,seq24414);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24415,seq24414__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24425__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24425__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24425__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24425__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24426 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24426,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24426,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24426,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24426,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24426,(4),null);
var arity = cljs.core.nth.call(null,vec__24426,(5),null);
...
var o__23456__auto__ = f;
return (o__23456__auto__["getBasis"]).call(o__23456__auto__);
});
/**
...
}catch (e24430){var _e__23463__auto__ = e24430;
...
var G__24431 = (obj[cljs.core.first.call(null,path)]);
var G__24432 = cljs.core.rest.call(null,path);
obj = G__24431;
path = G__24432;
continue;
} else {
...
return (function (accum,p__24433){
var vec__24434 = p__24433;
var bit = cljs.core.nth.call(null,vec__24434,(0),null);
var protocol = cljs.core.nth.call(null,vec__24434,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24437){
var vec__24438 = p__24437;
var ns = cljs.core.nth.call(null,vec__24438,(0),null);
var name = cljs.core.nth.call(null,vec__24438,(1),null);
var selector = cljs.core.nth.call(null,vec__24438,(2),null);
...
return (function (p__24442){
var vec__24443 = p__24442;
var munged_name = cljs.core.nth.call(null,vec__24443,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24443,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24443,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24441_SHARP_){
return (obj[cljs.core.first.call(null,p1__24441_SHARP_)]);
});})(name,sorted_matches,vec__24443,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1543803797986

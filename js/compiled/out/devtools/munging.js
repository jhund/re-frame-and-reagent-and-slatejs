...
var o24198 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24198["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24199 = temp__5455__auto____$1;
return (o24199["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23308__auto__ = f;
return (o__23308__auto__["toString"]).call(o__23308__auto__);
} else {
return "";
}
}catch (e24200){var _ = e24200;
return "";
}});
...
try{var o__23308__auto___24202 = t;
(o__23308__auto___24202["cljs$lang$ctorPrWriter"]).call(o__23308__auto___24202,t,writer);
}catch (e24201){var __24203 = e24201;
}
...
var char_code = (function (){var o__23308__auto__ = (new String(char$));
return (o__23308__auto__["charCodeAt"]).call(o__23308__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23308__auto__ = String;
return (o__23308__auto__["fromCharCode"]).call(o__23308__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24204 = num_code;
switch (G__24204) {
case (1):
return (185);
...
var o__23308__auto__ = String;
return (o__23308__auto__["fromCharCode"]).call(o__23308__auto__,superscript_code);
});
/**
...
}catch (e24206){var _e__23315__auto__ = e24206;
return false;
}})())){
...
var vec__24207 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24207,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24210 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24210["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24211 = temp__5455__auto____$1;
return (o24211["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___24218 = arguments.length;
var i__4532__auto___24219 = (0);
while(true){
if((i__4532__auto___24219 < len__4531__auto___24218)){
args__4534__auto__.push((arguments[i__4532__auto___24219]));

var G__24220 = (i__4532__auto___24219 + (1));
i__4532__auto___24219 = G__24220;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24214){
var vec__24215 = p__24214;
var ns_detector = cljs.core.nth.call(null,vec__24215,(0),null);
...
var G__24221 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24222 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24221;
remaining_tokens = G__24222;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24212){
var G__24213 = cljs.core.first.call(null,seq24212);
var seq24212__$1 = cljs.core.next.call(null,seq24212);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24213,seq24212__$1);
});
...
var vec__24226 = cljs.core.split_with.call(null,(function (p1__24225_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24225_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24226,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24226,(1),null);
...
var vec__24229 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24229,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24229,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24232 = cljs.core.rest.call(null,remaining_tokens);
var G__24233 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24232;
name_tokens = G__24233;
continue;
} else {
...
var vec__24236 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24236,(0),null);
var arity = cljs.core.nth.call(null,vec__24236,(1),null);
var vec__24239 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24239,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24239,(1),null);
var vec__24242 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24242,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24242,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24242,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24242,(3),null);
...
var vec__24248 = result;
var munged_ns = cljs.core.nth.call(null,vec__24248,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24248,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24248,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24248,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24248,(4),null);
var arity = cljs.core.nth.call(null,vec__24248,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__24252 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__24252,(0),null);
var args = cljs.core.nth.call(null,vec__24252,(1),null);
var vec__24255 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24255,(0),null);
var name = cljs.core.nth.call(null,vec__24255,(1),null);
...
var G__24258 = (arity + (1));
var G__24259 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24260){
var vec__24261 = p__24260;
var arity = cljs.core.nth.call(null,vec__24261,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24261,(1),null);
...
return cljs.core.get.call(null,arities,p1__24264_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24265_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24268){
var vec__24269 = p__24268;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24269,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24266){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24277__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24277__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24277__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24277__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24278 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24278,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24278,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24278,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24278,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24278,(4),null);
var arity = cljs.core.nth.call(null,vec__24278,(5),null);
...
var o__23308__auto__ = f;
return (o__23308__auto__["getBasis"]).call(o__23308__auto__);
});
/**
...
}catch (e24282){var _e__23315__auto__ = e24282;
...
var G__24283 = (obj[cljs.core.first.call(null,path)]);
var G__24284 = cljs.core.rest.call(null,path);
obj = G__24283;
path = G__24284;
continue;
} else {
...
return (function (accum,p__24285){
var vec__24286 = p__24285;
var bit = cljs.core.nth.call(null,vec__24286,(0),null);
var protocol = cljs.core.nth.call(null,vec__24286,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24289){
var vec__24290 = p__24289;
var ns = cljs.core.nth.call(null,vec__24290,(0),null);
var name = cljs.core.nth.call(null,vec__24290,(1),null);
var selector = cljs.core.nth.call(null,vec__24290,(2),null);
...
return (function (p__24294){
var vec__24295 = p__24294;
var munged_name = cljs.core.nth.call(null,vec__24295,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24295,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24295,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24293_SHARP_){
return (obj[cljs.core.first.call(null,p1__24293_SHARP_)]);
});})(name,sorted_matches,vec__24295,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1543701278695
